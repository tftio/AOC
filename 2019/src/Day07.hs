...
runProgram prog inputs = runProgram' inputs 0 prog

calcSignal :: Program -> [Int] -> Int
calcSignal prog [phase1, phase2, phase3, phase4, phase5] =
  let runP = runProgram prog
      ampA = runP $ phase1 : 0 : ampE
      ampB = runP $ phase2 : ampA
      ampC = runP $ phase3 : ampB
      ampD = runP $ phase4 : ampC
      ampE = runP $ phase5 : ampD in
  last ampE
calcSignal _ _ = error "Need exactly 5 phases to calculate signal"
